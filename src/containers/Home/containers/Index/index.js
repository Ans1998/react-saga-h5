...
import {actions as homeActions} from "../../../../redux/modules/home/action";
...
const mapStateToProps = (state, props) => {
    return {
        homeCommonUseDevice: state.home.homeCommonUseDeviceReducer.res.data.useddevice_list || [],
        homeSlide: state.home.homeSlideReducer.res.data.ads  || []
    }
};
